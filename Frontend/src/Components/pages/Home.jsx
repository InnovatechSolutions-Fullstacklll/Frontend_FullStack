...
function Home() {
  ...
  useEffect(() => {
    // Verificación si hay un token activo, hay que revisar cuando tengamos montado el backend y bff 
  ...
  return (
    <div className="home-page">
      ...
      {isLogged ? (
        // VISTA DEL USUARIO LOGUEADO: se mostrara la barra lateral de menu que estubimos hablando en clases
        <div className="dashboard-layout">
          ...
          <main className="dashboard-content">
            ...
            <p className="hero-text">
              ¡El futuro es hoy, viejo! Ya iniciaste sesión correctamente. Aquí puedes empezar a construir tu interfaz privada.
            </p>
          </main>
        </div>
      ) : (
        ...
        <main className="hero-section">
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              <Link to="/login">
                <button type="button" className="button-primary">Comenzar</button>
              </Link>
              <Link to="/crear-cuenta">
                <button type="button" className="button-secondary">Saber más</button>
              </Link>
            </div>
          </div>
